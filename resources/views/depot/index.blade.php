  ...
  <div class="modal-dialog  modal-notify modal-lg modal-right modal-success" role="document">
    ...
    <small class="text-muted d-block mt-1 mb-2">Attribué automatiquement à l'enregistrement.</small>
     ...
     <select id="create_origine" class="form-control" name="origine" required>
      ...
      <input type="text" class="form-control" name="nom" value="{{ old('nom') }}" placeholder="Nom et prénom du demandeur (optionnel)" maxlength="255">
    </div>
      <br>
      <div class="input-group">
        <div class="input-group-prepend">
  ...
  <div class="modal-dialog  modal-notify modal-lg modal-right modal-success" role="document">
    <div class="modal-content">
     ...
     <select id="edit_origine" class="form-control" name="origine" required>
      ...
      <input id="edit_nom" type="text" class="form-control" name="nom" value="{{ old('nom') }}" placeholder="Nom et prénom du demandeur (optionnel)" maxlength="255">
    </div>
      <br>
      <div class="input-group">
        <div class="input-group-prepend">
